...
class Themes_Pack_Custom_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<label>
			...
			<a href="https://wpmonks.com/downloads/theme-pack?src=customizer" target="_blank"><img src="<?php echo sfwf_URL; ?>/css/images/theme-pack.jpg"></a>
...
class Grid_Layout_Custom_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<label>
			<h2><?php echo esc_html( $this->label ); ?></h2>
			<a href="https://wpmonks.com/downloads/grid-layout?src=customizer" target="_blank"><img src="<?php echo sfwf_URL; ?>/css/images/grid-layout.jpg"></a>
...
class Field_Icons_Custom_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<label>
			<h2><?php echo esc_html( $this->label ); ?></h2>
			<a href="https://wpmonks.com/downloads/field-icons?src=customizer" target="_blank"><img src="<?php echo sfwf_URL; ?>/css/images/field-icons.jpg"></a>
...
class Custom_Themes_Custom_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<label>
			<h2><?php echo esc_html( $this->label ); ?></h2>
			<a href="https://wpmonks.com/downloads/custom-themes?src=customizer" target="_blank"><img src="<?php echo sfwf_URL; ?>/css/images/custom-themes.jpg"></a>
...
class Addon_Bundle_Custom_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<label>
			<h2><?php echo esc_html( $this->label ); ?></h2>
			<a href="https://wpmonks.com/downloads/addon-bundle?src=customizer" target="_blank"><img src="<?php echo sfwf_URL; ?>/css/images/addon-bundle.jpg"></a>
...
class More_Addons_Custom_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<label>
			<h2><?php echo esc_html( $this->label ); ?></h2>
			<a href="https://wpmonks.com/styles-and-layouts-for-gravity-forms/?src=customizer#x-section-6" target="_blank"><img src="<?php echo sfwf_URL; ?>/css/images/more-addons.jpg"></a>
...
class Material_Design_Custom_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<label>
			<h2><?php echo esc_html( $this->label ); ?></h2>
			<a href="https://wpmonks.com/downloads/material-design?src=customizer" target="_blank"><img src="<?php echo sfwf_URL; ?>/css/images/material-design.jpg"></a>
...
class Tooltips_Custom_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<label>
			<h2><?php echo esc_html( $this->label ); ?></h2>
			<a href="https://wpmonks.com/downloads/tooltips?src=customizer" target="_blank"><img src="<?php echo sfwf_URL; ?>/css/images/tooltips.jpg"></a>
...
class Customization_Support_Custom_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<label>
			<h2><?php echo esc_html( $this->label ); ?></h2>
			<a href="https://wpmonks.com/contact-us?src=customizer" target="_blank"><img src="<?php echo sfwf_URL; ?>/css/images/support.jpg"></a>
...
$wp_customize->add_setting(
	'sfwf_form_id_[addons][addon-bundle]',
	array(
		'default'   => '',
...
$wp_customize->add_control(
	new Addon_Bundle_Custom_Control(
		...
		'sfwf_form_id_[addons][addon-bundle]', // Setting id.
...
$wp_customize->add_setting(
	'sfwf_form_id_[addons][material-design]',
	array(
		'default'   => '',
		'transport' => 'postMessage',
		'type'      => 'option',
...
$wp_customize->add_control(
	new Material_Design_Custom_Control(
		$wp_customize, // WP_Customize_Manager.
		'sfwf_form_id_[addons][material-design]', // Setting id.
		array( // Args, including any custom ones.
...
$wp_customize->add_setting(
	'sfwf_form_id_[addons][grid-layout]',
	array(
		'default'   => '',
		'transport' => 'postMessage',
		'type'      => 'option',
...
$wp_customize->add_control(
	new Grid_Layout_Custom_Control(
		$wp_customize, // WP_Customize_Manager.
		'sfwf_form_id_[addons][grid-layout]', // Setting id.
		array( // Args, including any custom ones.
...
$wp_customize->add_setting(
	'sfwf_form_id_[addons][theme-pack]',
	array(
		'default'   => '',
		'transport' => 'postMessage',
		'type'      => 'option',
...
$wp_customize->add_control(
	new Themes_Pack_Custom_Control(
		$wp_customize, // WP_Customize_Manager.
		'sfwf_form_id_[addons][theme-pack]', // Setting id.
		array( // Args, including any custom ones.
			'label'   => __( 'Theme Pack' ),
			'section' => 'sfwf_form_id_addons',
		)
...
$wp_customize->add_setting(
	'sfwf_form_id_[addons][custom-themes]',
	array(
		'default'   => '',
		'transport' => 'postMessage',
		'type'      => 'option',
...
$wp_customize->add_control(
	new Custom_Themes_Custom_Control(
		$wp_customize, // WP_Customize_Manager.
		'sfwf_form_id_[addons][custom-themes]', // Setting id.
		array( // Args, including any custom ones.
